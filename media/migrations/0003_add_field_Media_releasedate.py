...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.releasedate'
        db.add_column(u'media_media', 'releasedate',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.releasedate'
        db.delete_column(u'media_media', 'releasedate')
